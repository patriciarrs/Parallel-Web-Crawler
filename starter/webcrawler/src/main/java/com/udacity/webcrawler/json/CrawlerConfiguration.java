 ...
 * <p>
 * The JsonDeserialize annotation is used to specify the builder class that Jackson should use when deserializing JSON into an instance of CrawlerConfiguration.
 */
...
public final class CrawlerConfiguration {
  ...
  public static final class Builder {
    ...
    /*
     * The JsonProperty annotation defines the mapping between the JSON properties and the builder methods.
     */
